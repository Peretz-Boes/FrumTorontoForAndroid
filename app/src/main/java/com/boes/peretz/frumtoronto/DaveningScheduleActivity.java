...
public class DaveningScheduleActivity extends AppCompatActivity {

    public static final String LOG_TAG=DaveningScheduleActivity.class.getSimpleName();
    WebView webView;
    String result="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_davening_schedule);
