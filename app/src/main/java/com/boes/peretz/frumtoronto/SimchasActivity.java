...
public class SimchasActivity extends AppCompatActivity {

    public static final String LOG_TAG=SimchasActivity.class.getSimpleName();
    WebView webView;
    String result="";
    ...
    public class ParseSimchasWebPage extends AsyncTask<String,Void,String> {
        @Override
