...
public class AdvertisingRatesActivity extends AppCompatActivity {

    public static final String LOG_TAG=AdvertisingRatesActivity.class.getSimpleName();
    WebView webView;
    String result="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advertising_rates);
    ...
    public class ParseAdvertisingRatesWebPage extends AsyncTask<String,Void,String> {
        @Override
